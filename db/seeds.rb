...
story20 = Story.create!(
  ...
  comment2 = Comment.create!(author_id: user2.id, story_id: story20.id, body: "This poem is truly beautiful. Thank you so much for sharing.")
  comment3 = Comment.create!(author_id: user3.id, story_id: story20.id, body: "You have no idea how much this poem has impacted me. Thanks a million.")
  comment4 = Comment.create!(author_id: user4.id, story_id: story19.id, body: "Posts like these remind me why I love Ouija. It's such a great place to connect with people!")
  comment5 = Comment.create!(author_id: user5.id, story_id: story18.id, body: "Wow. So powerful!")
  comment6 = Comment.create!(author_id: user6.id, story_id: story17.id, body: "You have such a unique writing style. I hope one day to be able to express my thoughts and emotions half as eloquently as you.")
  comment7 = Comment.create!(author_id: user7.id, story_id: story16.id, body: "Such a sweet way to start my day. Thanks for sharing!")
  comment8 = Comment.create!(author_id: user8.id, story_id: story15.id, body: "This poem is exquisite!")
  comment9 = Comment.create!(author_id: user9.id, story_id: story14.id, body: "Where on earth did you come up with this?! You have a brilliant mind.")
  comment10 = Comment.create!(author_id: user10.id, story_id: story13.id, body: "I'm going to share this with my friends and family! You've truly touched me.")
  comment11 = Comment.create!(author_id: user11.id, story_id: story12.id, body: "I am so happy I stumbled across your work. Lovely.")
  comment12 = Comment.create!(author_id: user12.id, story_id: story11.id, body: "I'm not usually one to leave comments, but this poem has compelled me to encourage other readers to stop and read. Really read it guys...there are so many layers here.")
  comment13 = Comment.create!(author_id: user13.id, story_id: story10.id, body: "I don't understand this at all and I love it.")
  comment14 = Comment.create!(author_id: user1.id, story_id: story9.id, body: "I can't get enough of your poetry! Very thought-provoking and impactful.")
  comment15 = Comment.create!(author_id: user2.id, story_id: story8.id, body: "Today, I am grateful for this poem. I am grateful for Ouija!  It will be a glorious day!")
  comment16 = Comment.create!(author_id: user3.id, story_id: story7.id, body: "The Ouija community is so inviting and comforting. Poems like this keep me going!")
  comment1 = Comment.create!(author_id: user4.id, story_id: story6.id, body: "I rarely find poems that I like, and yours is just remarkable. Looking forward to reading more of your work.")
  comment1 = Comment.create!(author_id: user5.id, story_id: story5.id, body: "How lucky am I to have poems like this at my fingertips?! I just can't get enough!")
  comment1 = Comment.create!(author_id: user6.id, story_id: story4.id, body: "Poetry bores me, but THIS poetry moves me. Thank you for sharing.")
  comment1 = Comment.create!(author_id: user7.id, story_id: story3.id, body: "I hope to be brave enough to share my own poetry with the world one day... If I ever do, trust that it'll be on Ouija first!")
  comment1 = Comment.create!(author_id: user8.id, story_id: story2.id, body: "I disagree with the underlying message, but appreciate your style of prose.")
  comment1 = Comment.create!(author_id: user9.id, story_id: story1.id, body: "Powerful! Intriguing! Impressive! Just wow!")
