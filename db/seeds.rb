...
Like.create!(user_id: user3.id, story_id: story1.id)
...
Like.create!(user_id: user4.id, story_id: story4.id)
...
Like.create!(user_id: user5.id, story_id: story3.id)
...
Like.create!(user_id: user2.id, story_id: story13.id)
...
Like.create!(user_id: user6.id, story_id: story11.id)
...
Like.create!(user_id: user8.id, story_id: story5.id)
...
Like.create!(user_id: user1.id, story_id: story7.id)
Like.create!(user_id: user9.id, story_id: story8.id)
Like.create!(user_id: user9.id, story_id: story7.id)
Like.create!(user_id: user9.id, story_id: story10.id)
...
Like.create!(user_id: user10.id, story_id: story8.id)
Like.create!(user_id: user11.id, story_id: story1.id)
Like.create!(user_id: user11.id, story_id: story3.id)
Like.create!(user_id: user11.id, story_id: story9.id)
...
Like.create!(user_id: user12.id, story_id: story1.id)
